...
if (($_FILES["file"]["type"] == "text/xml") && ($_FILES["file"]["name"] == "Export.xml")) {
	if ($_FILES["file"]["error"] > 0) {
		...
		foreach ($xml->children() as $child) {
			...
			$query = "INSERT INTO Course ( cName, cType, cMajor, cYear, cGrade, cCode, cDate, cTime, cRoom, cProf, cMaxNum) VALUES ('" . $temp . "') ;";

			mysqli_query($conn, 'set names utf8');
			mysqli_query($conn, $query);
			//echo"INSERT INTO Course ( cName, cType, cMajor, cYear, cGrade, cCode, cDate, cProf, cMaxNum) VALUES ('" . $temp . "'); ";
			echo "('" . $temp . "'); <br>";
